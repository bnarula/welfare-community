...
function mcImgSlider(i) {
	...
	}, P = document, J = window.requestAnimationFrame, W = window.cancelAnimationFrame, db = [
			"ms", "webkit" ], v = "", V = 0; V < db[d]; V++)
	...
	var yb = function() {
		...
		if (a)
			if (typeof a.insertRule != "undefined") {
				...
				var c = "#"
						+ i.sliderId
						+ " .bgLayer{position:absolute;width:100%;height:100%;background-size:cover !important;}";
				a.insertRule(c, 0);
				var d = "#"
						+ i.sliderId
						+ "::before {"
	...
	sb();
	var c = "style", H = "display", Eb = "visibility", r = "width", q = "height", O = "top", B = "background", p = "undefined", Fb = "marginLeft", F = "appendChild", l = "parentNode", k = "nodeName", S = "innerHTML", cb = "offsetWidth", u = setTimeout, z = clearTimeout, w = "indexOf", N = "setAttribute", bb = "removeChild", L = function() {
		this.d = [];
		this.b = null
	}, zb = function() {
		...
		if (a[w]("Opera") != -1)
			b = 400;
		return b
	}, T = zb() < 9, ab = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i
	...
	var G = new L, gb = function() {
		...
		c : 0,
		b : 0
	}, a, f, o, s, D, A, m, R, x, M, X, e, E, j = null, vb = function() {
	...
	}, qb = [ "$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22" ], kb = function() {
		if (b.b != 2) {
			b.b = 1;
			z(m);
			m = null
